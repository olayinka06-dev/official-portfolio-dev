    ...
    return(
        <Wrapper>
            <main>
                ...
                <section>
                    <h2>Summary</h2>
                    <p>Highly skilled and motivated frontend developer with 1 year of experience in building responsive and user-friendly web applications. Proficient in HTML, CSS, JavaScript, and modern frontend frameworks. Strong problem-solving abilities and a passion for creating engaging user experiences.</p>
                </section>
                ...
                <article>
                    <h3> Frontend Developer | Toshconsultinc Technologies | Mar 2021 - Present</h3>
                    <ul>
                ...
                <article>
                    ...
                    <p>Live URL: <a href="https://horlly-weather-app.netlify.app">Link</a></p>
                </article>
            
                <article>
                    <h3>Portfolio Website</h3>
                    <p>Description: Built a personal portfolio website to showcase frontend development projects and skills, demonstrating proficiency in HTML, CSS, JavaScript and React</p>
                    <p>Live Url: <a href="https://olayinka-dev-portfolio.netlify.app/">Link</a></p>
                </article>
        
                <article>
                    <h3>Url_Shortener Website</h3>
                    <p>Description: A responsive shortening url website with Api</p>
                    <p>Live URL: <a href="https://horlly-url-shortener.netlify.app">Link</a></p>
                </article>
        
                <article>
                    <h3>Dictionary Website</h3>
                    <p>Description: A Functioning Dictionary App Bult with Dictionary Api</p>
                    <p>Live URL: <a href="https://dictionary-app-1.netlify.app/">Link</a></p>
                </article>
                </section>
                ...
                <ul>
                    <li>Received the "Outstanding Contribution" award for exceptional performance and dedication in frontend development at Toshconsultinc Company.</li>
                </ul>
                </section>
                ...
                <section>
                    ...
                    <p>Click to view my Portfolio Website: <a href="https://olayinka-dev-portfolio.netlify.app/">Click</a></p>
                </section>
            </main>
        </Wrapper>
    )
...
const Wrapper = styled.main`
    *{
    ...
    @keyframes animate {
        0%{color: hsl(136, 65%, 51%);}
        100%{color: hsl(192, 70%, 51%);}
    }
    h1 {
      font-size: 32px;
      margin: 0;
