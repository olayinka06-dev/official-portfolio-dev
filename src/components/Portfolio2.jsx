...
{/* <div>
<div className="top">
  <div onClick={() => setSelectedFilter('All')} className={selectedFilter === 'All' ? 'active' : ''}>All</div>
  <div onClick={() => setSelectedFilter('Website')} className={selectedFilter === 'Website' ? 'active' : ''}>Website</div>
  <div onClick={() => setSelectedFilter('App')} className={selectedFilter === 'App' ? 'active' : ''}>App</div>
  <div onClick={() => setSelectedFilter('Blog')} className={selectedFilter === 'Blog' ? 'active' : ''}>Blog</div>
</div>
